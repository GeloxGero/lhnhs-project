      ...
      return filtered
        .map(function (property) {
          ...
          if (property === "seconds" && this.milliseconds) {
            value = (value + this.milliseconds / 1e3)
              .toFixed(6)
              .replace(/\.?0+$/, "");
          }
...
var require_binaryParsers = __commonJS({
  "node_modules/pg-types/lib/binaryParsers.js"(exports, module) {
    ...
    var parseBits = /* @__PURE__ */ __name(function (
      data,
      bits,
      offset,
      invert,
    ...
    var parseFloatFromBits = /* @__PURE__ */ __name(function (
      data,
      precisionBits,
      exponentBits,
    ) {
      ...
      var parsePrecisionBits = /* @__PURE__ */ __name(function (
        lastValue,
        newValue,
        bits,
      ) {
    ...
    var parseDate = /* @__PURE__ */ __name(function (isUTC, value) {
      ...
      var result = new Date(
        ((sign3 === 0 ? 1 : -1) * rawValue) / 1e3 + 9466848e5,
      );
      if (!isUTC) {
  ...
  "node_modules/pg/lib/defaults.js"(exports, module) {
    ...
    module.exports.__defineSetter__("parseInt8", function (val) {
      pgTypes.setTypeParser(
        20,
        "text",
        val ? pgTypes.getTypeParser(23, "text") : parseBigInteger,
      );
      pgTypes.setTypeParser(
        1016,
        "text",
  ...
  "node_modules/pg/lib/utils.js"(exports, module) {
        ...
        if (val[i] === null || typeof val[i] === "undefined") {
          ...
          if (!(item instanceof Buffer)) {
            ...
            if (buf.length === item.byteLength) {
              ...
              item = buf.slice(
                item.byteOffset,
                item.byteOffset + item.byteLength,
              );
            }
          }
    ...
    function dateToString(date2) {
      ...
      let ret =
        ...
        "." +
        String(date2.getMilliseconds()).padStart(3, "0");
      if (offset < 0) {
        ret += "-";
        offset *= -1;
      } else {
    ...
    function dateToStringUTC(date2) {
      ...
      let ret =
        ...
        ":" +
        String(date2.getUTCSeconds()).padStart(2, "0") +
        "." +
        String(date2.getUTCMilliseconds()).padStart(3, "0");
      ret += "+00:00";
      if (isBCYear) ret += " BC";
      return ret;
    }
  ...
  "node_modules/pg/lib/crypto/utils-webcrypto.js"(exports, module) {
    ...
    async function md5(string) {
      try {
        ...
        const data =
          typeof string === "string" ? textEncoder.encode(string) : string;
...
var require_cert_signatures = __commonJS({
  "node_modules/pg/lib/crypto/cert-signatures.js"(exports, module) {
    ...
    function readASN1OID(data, index) {
      ...
      const { length: OIDLength, index: indexAfterOIDLength } = readASN1Length(
        data,
        index,
      );
    ...
    function signatureAlgorithmHashFromCertificate(data, index) {
      ...
      const { length: certInfoLength, index: indexAfterCertInfoLength } =
...
var require_sasl = __commonJS({
  "node_modules/pg/lib/crypto/sasl.js"(exports, module) {
    ...
    function startSession(mechanisms, stream) {
      ...
      const mechanism = candidates.find((candidate) =>
        mechanisms.includes(candidate),
      );
      if (!mechanism) {
        throw new Error(
          "SASL: Only mechanism(s) " +
            candidates.join(" and ") +
            " are supported",
        );
      }
      if (
        ...
        throw new Error(
          "SASL: Mechanism SCRAM-SHA-256-PLUS requires a certificate",
        );
      }
    ...
    async function continueSession(session, password, serverData, stream) {
      ...
      const serverFirstMessage =
        "r=" + sv.nonce + ",s=" + sv.salt + ",i=" + sv.iteration;
      ...
      const serverSignatureBytes = await crypto2.hmacSha256(
        serverKey,
        authMessage,
      );
      session.message = "SASLResponse";
      session.serverSignature =
        Buffer.from(serverSignatureBytes).toString("base64");
...
var require_type_overrides = __commonJS({
  "node_modules/pg/lib/type-overrides.js"(exports, module) {
    ...
    TypeOverrides2.prototype.getTypeParser = function (oid, format) {
      format = format || "text";
      return (
        this.getOverrides(format)[oid] || this._types.getTypeParser(oid, format)
      );
    };
...
var require_pg_connection_string = __commonJS({
  "node_modules/pg-connection-string/index.js"(exports, module) {
    ...
    function deprecatedSslModeWarning(sslmode) {
      if (
        !deprecatedSslModeWarning.warned &&
    ...
    var ConnectionParameters = class {
      ...
      constructor(config) {
        ...
        if (config.connectionTimeoutMillis === void 0) {
          ...
          this.connect_timeout = Math.floor(
            config.connectionTimeoutMillis / 1e3,
          );
        }
        ...
        if (typeof config.keepAliveInitialDelayMillis === "number") {
          this.keepalives_idle = Math.floor(
            config.keepAliveInitialDelayMillis / 1e3,
          );
        }
      }
      getLibpqConnectionString(cb) {
        ...
        if (this.client_encoding) {
          params.push(
            "client_encoding=" + quoteParamValue(this.client_encoding),
          );
        }
    ...
    var Result2 = class {
      ...
      addFields(fieldDescriptions) {
        ...
        for (let i = 0; i < fieldDescriptions.length; i++) {
          ...
          row[desc2.name] = null;
          if (this._types) {
            this._parsers[i] = this._types.getTypeParser(
              desc2.dataTypeID,
              desc2.format || "text",
            );
          } else {
            this._parsers[i] = types3.getTypeParser(
              desc2.dataTypeID,
              desc2.format || "text",
            );
          }
...
var require_messages = __commonJS({
  "node_modules/pg-protocol/dist/messages.js"(exports) {
    ...
    exports.NoticeMessage =
      exports.DataRowMessage =
      exports.CommandCompleteMessage =
      exports.ReadyForQueryMessage =
      exports.NotificationResponseMessage =
      exports.BackendKeyDataMessage =
      exports.AuthenticationMD5Password =
      exports.ParameterStatusMessage =
      exports.ParameterDescriptionMessage =
      exports.RowDescriptionMessage =
      exports.Field =
      exports.CopyResponse =
      exports.CopyDataMessage =
...
var require_serializer = __commonJS({
  "node_modules/pg-protocol/dist/serializer.js"(exports) {
    ...
    var sendSASLInitialResponseMessage = /* @__PURE__ */ __name(function (
      mechanism,
      initialResponse,
    ) {
      writer
    ...
    var sendSCRAMClientFinalMessage = /* @__PURE__ */ __name(function (
      additionalData,
    ) {
    ...
    var codeOnlyBuffer = /* @__PURE__ */ __name(
      (code) => Buffer.from([code, 0, 0, 0, 4]),
      "codeOnlyBuffer",
    );
  ...
  "node_modules/pg-protocol/dist/parser.js"(exports) {
    ...
    var Parser = class {
      ...
      constructor(opts) {
        ...
        if (
          (opts === null || opts === void 0 ? void 0 : opts.mode) === "binary"
        ) {
          throw new Error("Binary mode not supported yet");
        }
        this.mode =
          (opts === null || opts === void 0 ? void 0 : opts.mode) || "text";
      }
    ...
    var parseCopyInMessage = /* @__PURE__ */ __name(
      (reader) => parseCopyMessage(reader, "copyInResponse"),
      "parseCopyInMessage",
    );
    var parseCopyOutMessage = /* @__PURE__ */ __name(
    ...
    var parseCopyMessage = /* @__PURE__ */ __name((reader, messageName) => {
      ...
      const message = new messages_1.CopyResponse(
        LATEINIT_LENGTH,
        messageName,
        isBinary,
        columnCount,
    ...
    var parseNotificationMessage = /* @__PURE__ */ __name((reader) => {
      ...
      return new messages_1.NotificationResponseMessage(
        LATEINIT_LENGTH,
        processId,
        channel,
        payload,
    ...
    var parseRowDescriptionMessage = /* @__PURE__ */ __name((reader) => {
      ...
      const message = new messages_1.RowDescriptionMessage(
        LATEINIT_LENGTH,
        fieldCount,
      );
    ...
    var parseParameterDescriptionMessage = /* @__PURE__ */ __name((reader) => {
      ...
      const message = new messages_1.ParameterDescriptionMessage(
        LATEINIT_LENGTH,
        parameterCount,
      );
    ...
    var parseParameterStatusMessage = /* @__PURE__ */ __name((reader) => {
      ...
      return new messages_1.ParameterStatusMessage(
        LATEINIT_LENGTH,
        name,
        value,
      );
    ...
    var parseBackendKeyData = /* @__PURE__ */ __name((reader) => {
      ...
      return new messages_1.BackendKeyDataMessage(
        LATEINIT_LENGTH,
        processID,
        secretKey,
      );
    }, "parseBackendKeyData");
    var parseAuthenticationResponse = /* @__PURE__ */ __name(
      (reader, length) => {
        ...
        switch (code) {
          ...
          case 5:
            if (message.length === 12) {
              ...
              return new messages_1.AuthenticationMD5Password(
                LATEINIT_LENGTH,
                salt,
              );
            }
    ...
    var CloudflareSocket = class extends events_1.EventEmitter {
      ...
      startTls(options) {
        if (this._upgraded) {
          this.emit(
            "error",
            "Cannot call `startTls()` more than once on a socket",
          );
          return;
        }
  ...
  "node_modules/pg/lib/connection.js"(exports, module) {
    ...
    var Connection2 = class extends EventEmitter {
      ...
      sendSASLInitialResponseMessage(mechanism, initialResponse) {
        this._send(
          serialize2.sendSASLInitialResponseMessage(mechanism, initialResponse),
        );
      }
...
var require_helper = __commonJS({
  "node_modules/pgpass/lib/helper.js"(exports, module) {
    ...
    function warn() {
      var isWritable =
        warnStream instanceof Stream && true === warnStream.writable;
      if (isWritable) {
    ...
    var matcher = (module.exports.match = function (connInfo, entry) {
      return fieldNames.slice(0, -1).reduce(function (prev, field, idx) {
        ...
        return (
          prev && (entry[field] === "*" || entry[field] === connInfo[field])
        );
      }, true);
    });
    ...
    var isValidEntry = (module.exports.isValidEntry = function (entry) {
      var rules = {
        ...
        1: function (x) {
          ...
          x = Number(x);
          return (
            isFinite(x) && x > 0 && x < 9007199254740992 && Math.floor(x) === x
          );
        },
        // database
        2: function (x) {
    ...
    var Client2 = class extends EventEmitter {
      ...
      _handleAuthMD5Password(msg) {
        this._getPassword(async () => {
          try {
            const hashedPassword = await crypto2.postgresMd5PasswordHash(
              this.user,
              this.password,
              msg.salt,
            );
      ...
      _handleRowDescription(msg) {
        ...
        if (activeQuery == null) {
          const error = new Error(
            "Received unexpected rowDescription message from backend.",
          );
          this._handleErrorEvent(error);
          return;
        }
      ...
      _handleDataRow(msg) {
        ...
        if (activeQuery == null) {
          const error = new Error(
            "Received unexpected dataRow message from backend.",
          );
          this._handleErrorEvent(error);
          return;
        }
      ...
      _handlePortalSuspended(msg) {
        ...
        if (activeQuery == null) {
          const error = new Error(
            "Received unexpected portalSuspended message from backend.",
          );
          this._handleErrorEvent(error);
          return;
        }
      ...
      _handleEmptyQuery(msg) {
        ...
        if (activeQuery == null) {
          const error = new Error(
            "Received unexpected emptyQuery message from backend.",
          );
          this._handleErrorEvent(error);
          return;
        }
      ...
      _handleCopyInResponse(msg) {
        ...
        if (activeQuery == null) {
          const error = new Error(
            "Received unexpected copyInResponse message from backend.",
          );
          this._handleErrorEvent(error);
          return;
        }
      ...
      _handleCopyData(msg) {
        ...
        if (activeQuery == null) {
          const error = new Error(
            "Received unexpected copyData message from backend.",
          );
          this._handleErrorEvent(error);
          return;
        }
      ...
      getStartupConf() {
        ...
        const appName =
          params.application_name || params.fallback_application_name;
        if (appName) {
        ...
        if (params.statement_timeout) {
          data.statement_timeout = String(
            parseInt(params.statement_timeout, 10),
          );
        }
    ...
    var Pool3 = class extends EventEmitter {
      ...
      _afterConnect(client, pendingItem, idleListener) {
        if (this.options.maxLifetimeSeconds !== 0) {
          const maxLifetimeTimeout = setTimeout(() => {
            ...
            const idleIndex = this._idle.findIndex(
              (idleItem) => idleItem.client === client,
            );
            if (idleIndex !== -1) {
              this._acquireClient(
                client,
                new PendingItem((err, client2, clientRelease) =>
                  clientRelease(),
                ),
                idleListener,
                false,
      ...
      get expiredCount() {
        return this._clients.reduce(
          (acc, client) => acc + (this._expired.has(client) ? 1 : 0),
          0,
        );
      }
      get totalCount() {
    ...
    Client2.prototype.query = function (config, values, callback) {
      ...
      if (config === null || config === void 0) {
        ...
        if (!query.callback) {
          ...
          query.callback = (err, res) =>
            err ? rejectOut(err) : resolveOut(res);
        }
      }
      if (readTimeout) {
        queryCallback = query.callback || (() => {});
...
var require_lib2 = __commonJS({
  "node_modules/pg/lib/index.js"(exports, module) {
    ...
    var { escapeIdentifier: escapeIdentifier2, escapeLiteral: escapeLiteral2 } =
      require_utils();
...
// .wrangler/tmp/bundle-f4gYUI/middleware-loader.entry.ts
init_modules_watch_stub();

// .wrangler/tmp/bundle-f4gYUI/middleware-insertion-facade.js
init_modules_watch_stub();
    ...
    app6.routes.map((r) => {
      ...
      if (app6.errorHandler === errorHandler) {
        ...
        handler = /* @__PURE__ */ __name(
          async (c, next) =>
            (await compose([], app6.errorHandler)(c, () => r.handler(c, next)))
              .res,
          "handler",
        );
...
var parse = /* @__PURE__ */ __name((cookie, name) => {
  ...
  for (const pairStr of pairs) {
    ...
    const cookieName = trimCookieWhitespace(
      pairStr.substring(0, valueStartPos),
    );
    if (
    ...
    let cookieValue = trimCookieWhitespace(
      pairStr.substring(valueStartPos + 1),
    );
...
// node_modules/hono/dist/utils/jwt/jwt.js
var encodeJwtPart = /* @__PURE__ */ __name(
  (part) =>
...
var encodeSignaturePart = /* @__PURE__ */ __name(
  (buf) => encodeBase64Url(buf).replace(/=/g, ""),
  "encodeSignaturePart",
);
var decodeJwtPart = /* @__PURE__ */ __name(
  (part) => JSON.parse(utf8Decoder.decode(decodeBase64Url(part))),
  "decodeJwtPart",
);
...
var sign = /* @__PURE__ */ __name(
  async (payload, privateKey, alg = "HS256") => {
...
// src/server/middleware/auth.ts
var accessAuth = createMiddleware(async (c, next) => {
...
// src/server/middleware/cors.ts
var localCors = createMiddleware(async (c, next) => {
  if (c.env.ENVIRONMENT === "development") {
...
var ExtraConfigColumns = /* @__PURE__ */ Symbol.for(
  "drizzle:ExtraConfigColumns",
);
var OriginalName = /* @__PURE__ */ Symbol.for("drizzle:OriginalName");
var BaseName = /* @__PURE__ */ Symbol.for("drizzle:BaseName");
var IsAlias = /* @__PURE__ */ Symbol.for("drizzle:IsAlias");
var ExtraConfigBuilder = /* @__PURE__ */ Symbol.for(
...
var PgTimestampString = class extends PgColumn {
  ...
  mapFromDriverValue(value) {
    ...
    if (this.withTimezone) {
      ...
      return `${shortened}${sign3}${Math.floor(Math.abs(offset) / 60)
        .toString()
        .padStart(2, "0")}`;
    }
    return shortened;
...
// node_modules/drizzle-orm/pg-core/table.js
var InlineForeignKeys = /* @__PURE__ */ Symbol.for(
  "drizzle:PgInlineForeignKeys",
);
...
var PgMaterializedViewConfig = /* @__PURE__ */ Symbol.for(
...
var PgSchema = class {
  ...
  enum(enumName, input) {
    return Array.isArray(input)
      ? pgEnumWithSchema(enumName, [...input], this.schemaName)
...
var NodePgSession = class _NodePgSession extends PgSession {
  ...
  async transaction(transaction, config) {
    const isPool =
      this.client instanceof Pool2 ||
      Object.getPrototypeOf(this.client).constructor.name.includes("Pool");
    ...
    await tx.execute(
      sql`begin${config ? sql` ${tx.getTransactionConfigSQL(config)}` : void 0}`,
    );
    try {
...
// src/server/db/schema/indexSchema.ts
var indexSchema_exports = {};
__export(indexSchema_exports, {
  general_expenditure: () => general_expenditure,
  user_roles: () => user_roles,
  users: () => users,
});
init_modules_watch_stub();

// src/server/db/schema/usersSchema.ts
init_modules_watch_stub();

// src/server/db/schema/app_schema.ts
init_modules_watch_stub();
var app_schema = pgSchema("app_schema");

// src/server/db/schema/usersSchema.ts
var user_roles = app_schema.enum("role", ["user", "admin", "moderator"]);
var users = app_schema.table("users", {
...
// src/server/db/db.ts
var getDb = /* @__PURE__ */ __name((connectionString) => {
  return drizzle(connectionString, { schema: indexSchema_exports });
}, "getDb");

// src/server/routes/generalExpeditureRoute.ts
var app2 = new Hono2();
app2.get("/", (c) => c.json("general expenditure get endpoint"));
app2.post("/", (c) => c.json("general expenditure endpoint"));
app2.get("/expenditure", (c) =>
...
var generalExpeditureRoute_default = app2;

// src/server/routes/expenseSummaryRoute.ts
init_modules_watch_stub();

// src/server/mockData.ts
init_modules_watch_stub();
var EXPENSE_SUMMARY_MOCK_DATA = [
  {
    unspc: null,
...
// src/server/db/schema/expenseItemSchema.ts
init_modules_watch_stub();
var expense_item = app_schema.table("expense_item", {
  id: serial("id").primaryKey(),
  unspc: text("unspc"),
...
// src/server/routes/authRoute.ts
init_modules_watch_stub();
...
app4.post("/login", async (c) => {
  ...
  try {
    const user = await db.query.users.findFirst({
      where: /* @__PURE__ */ __name(
        (users2, { eq: eq2 }) => eq2(users2.email, email),
        "where",
      ),
    });
    if (!user)
      return c.json({ error: `No user with email: ${email}found!` }, 404);
    const match2 = await verifyPassword(password, user.passwordHash);
    if (!match2) return c.json({ error: "Invalid password!" }, 401);
...
app5.route(
  "/api/protected/general_expenditure",
  generalExpeditureRoute_default,
);
app5.route("/api/protected/expense_summary", expenseSummaryRoute_default);
