...
var require_messages = __commonJS({
  "node_modules/pg/node_modules/pg-protocol/dist/messages.js"(exports) {
    "use strict";
    init_modules_watch_stub();
...
var require_buffer_writer = __commonJS({
  "node_modules/pg/node_modules/pg-protocol/dist/buffer-writer.js"(exports) {
    "use strict";
    init_modules_watch_stub();
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_serializer = __commonJS({
  "node_modules/pg/node_modules/pg-protocol/dist/serializer.js"(exports) {
    "use strict";
    init_modules_watch_stub();
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_buffer_reader = __commonJS({
  "node_modules/pg/node_modules/pg-protocol/dist/buffer-reader.js"(exports) {
    "use strict";
    init_modules_watch_stub();
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_parser = __commonJS({
  "node_modules/pg/node_modules/pg-protocol/dist/parser.js"(exports) {
    "use strict";
    init_modules_watch_stub();
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_dist = __commonJS({
  "node_modules/pg/node_modules/pg-protocol/dist/index.js"(exports) {
    "use strict";
    init_modules_watch_stub();
    Object.defineProperty(exports, "__esModule", { value: true });
...
// src/server/db/schema/usersSchema.ts
var user_roles = app_schema.enum("role", [
  "user",
  "admin",
  "moderator"
]);
...
app2.post("/batch_import", async (c) => {
  ...
  const ids = await db.insert(general_expenditure).values(data).returning({ id: general_expenditure.id });
  return c.json(
    {
...
app3.get("/ar_get_expenses", async (c) => {
  ...
  try {
    ...
    }).from(expense_item).where(eq(expense_item.arCode, Number(arCode))).groupBy(expense_item.id);
  } catch (e) {
    return c.json({ message: "Internal server error" }, 500);
  } finally {
...
app3.post("/ar_code_seed", async (c) => {
  ...
  const mockItem = EXPENSE_SUMMARY_MOCK_DATA[Math.floor(Math.random() * EXPENSE_SUMMARY_MOCK_DATA.length)];
  const data = {
    ...mockItem,
...
app4.post("/login", async (c) => {
  ...
  try {
    const user = await db.query.users.findFirst({
      where: /* @__PURE__ */ __name((users2, { eq: eq2 }) => eq2(users2.email, email), "where")
    });
    if (!user)
...
app4.post("/signup", async (c) => {
  ...
  try {
    const [users_instance] = await db.insert(users).values({ email, passwordHash: hashedPassword }).returning({ id: users.id });
...
app5.route("/api/protected/general_expenditure", generalExpeditureRoute_default);
