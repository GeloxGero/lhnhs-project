...
// .wrangler/tmp/bundle-xfRoAU/middleware-loader.entry.ts
init_modules_watch_stub();

// .wrangler/tmp/bundle-xfRoAU/middleware-insertion-facade.js
init_modules_watch_stub();
...
app4.post("/login", async (c) => {
  ...
  try {
    ...
    await setSignedCookie(c, "signed-cookie", token, c.env.JWT_SECRET, {
      path: "/",
