...
var InlineForeignKeys2 = /* @__PURE__ */ Symbol.for(
...
function drizzle(client, config = {}) {
  ...
  const session = new SQLiteD1Session(client, dialect, schema, {
    logger: logger2,
    cache: config.cache,
  });
...
app2.post("/batch_import", async (c) => {
  ...
  console.log(data);
  return c.json({ message: "batch_import api reached", data });
});
...
// .wrangler/tmp/bundle-cGXih1/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-cGXih1/middleware-loader.entry.ts
