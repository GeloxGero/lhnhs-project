...
// .wrangler/tmp/bundle-uJL4IO/middleware-loader.entry.ts
init_modules_watch_stub();

// .wrangler/tmp/bundle-uJL4IO/middleware-insertion-facade.js
init_modules_watch_stub();
...
// src/server/index.ts
var app5 = new Hono2();
if (app5) app5.route("/api/users", userRoute_default);
