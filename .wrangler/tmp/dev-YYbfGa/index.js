...
app4.post("/login", async (c) => {
  ...
  try {
    const user = await db.query.users.findFirst({ with: { email } });
...
// .wrangler/tmp/bundle-hUbxoi/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-hUbxoi/middleware-loader.entry.ts
