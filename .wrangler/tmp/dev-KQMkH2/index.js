...
// .wrangler/tmp/bundle-nsQvsr/middleware-loader.entry.ts
init_modules_watch_stub();

// .wrangler/tmp/bundle-nsQvsr/middleware-insertion-facade.js
init_modules_watch_stub();
...
app2.get("/get_by_year", async (c) => {
  ...
  const expenditures = await db
    ...
    .where(eq(general_expenditure.year, Number(year)));
