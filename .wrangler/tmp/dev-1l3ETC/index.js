...
// .wrangler/tmp/bundle-q80IWF/middleware-loader.entry.ts
init_modules_watch_stub();

// .wrangler/tmp/bundle-q80IWF/middleware-insertion-facade.js
init_modules_watch_stub();
...
app2.get("/get_by_year", async (c) => {
  ...
  return c.json({ message: `General Expeditures`, data: expenditures });
});
